...
export class FirebaseAuthenticationService {
  ...
  private phoneVerificationFailedSubject =
    new Subject<PhoneVerificationFailedEvent>();
  ...
  public get phoneVerificationFailed$(): Observable<PhoneVerificationFailedEvent> {
    return this.phoneVerificationFailedSubject.asObservable();
  }
